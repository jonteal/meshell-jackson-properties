  ...
  return (
    ...
    <div  className="contact-wrapper">
        <div className="contact-left">
            <h1 className="contact-title">Give us a call with your questions today!</h1>
        ...
        <div className="contact-right">
            <p className="contact-desc">
                <b>We are here for you.</b> Reach out to us to find your next home away from home!
            </p>

            {/* Form to reach out via email */}
            <form ref={formRef} onSubmit={handleSubmit}>
                <input tabIndex={"0"} type="text" placeholder="Name" name="user_name" />
